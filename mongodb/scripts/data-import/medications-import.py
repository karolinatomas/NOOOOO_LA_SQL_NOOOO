...
print("Old data was succesfully deleted.")
...
try:
    ...
    print(f"Some data cannot be added: {errors_count} error.")
...
# Summary
print(f"Import is completed with {db.medications.count_documents({})} records in collection")